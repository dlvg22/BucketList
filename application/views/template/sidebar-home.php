  ...
  <div class="modal-content slide">
    ...
    ?>
		...
		<div class="home-about" >
			...
			<span class="glyphicon glyphicon-user about-title icon-color"></span>&nbsp;<strong>About</strong><?=$motto!=null?'<span class="pull-right icon-color glyphicon glyphicon-pencil" id="pen"></span>':''?>
			<p class="text-center about-title" id="mt">	<?php
				if($motto==' '||null){

				echo '<a hre="" id="motto">Tell me about your self</a>
					<div id="mymotto">
		
					<input type="hidden" id="userID" value ="'.$userID.'"></input>
						<textarea type="text" id="inMotto"></textarea>
						<button type="submit" class="btn btn-primary btn-sm pull-right" id="pmotto">POST</button>	
